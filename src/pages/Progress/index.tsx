  ...
  return (
    <div className="min-h-screen bg-bg-primary pb-20">
      ...
      <header className="px-5 pt-6 pb-4 border-b-2 border-text-muted/20">
        <h1 className="font-display text-2xl font-extrabold uppercase tracking-wide">Haladás</h1>
        <p className="text-text-muted text-sm mt-1">Heti volumen és statisztikák</p>
      </header>
